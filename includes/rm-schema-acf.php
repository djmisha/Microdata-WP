...
class RM_Schema_ACF {
	...
	public static function add_fields_rm_site_schema( $parent ) {
		...
		acf_add_local_field( array(
			...
			'value' => self::$plugin_data == false? '' : self::$plugin_data['site_logo']
		) );
		...
		acf_add_local_field( array(
            ...
            'value' => self::$plugin_data == false? '' : self::$plugin_data['site_name']
		) );
		...
		acf_add_local_field( array(
            ...
            'value' => self::$plugin_data == false? '' : self::$plugin_data['site_about']
		) );
		...
		acf_add_local_field( array(
            ...
            'value' => self::$plugin_data == false? '' : self::$plugin_data['main_phone']
		) );
		...
		acf_add_local_field( array(
			...
			'label'		=> 'About Us Link',
			'type'		=> 'link',
            'value' => self::$plugin_data == false? '' : self::$plugin_data['about_us_link']
		) );
		...
		acf_add_local_field( array(
            ...
            'value' => self::$plugin_data == false? '' : self::$plugin_data['sitelinks_searchbox']
		) );
		...
		acf_add_local_field( array(
			...
			'layout'		=> 'horizontal',
			'other_choice'	=> true,
			'value' => self::$plugin_data == false? '' : self::$plugin_data['organization_type']
		) );
		...
		acf_add_local_field( array(
            ...
            'value' => self::$plugin_data == false? '' : self::$plugin_data['price_range']
		) );
		...
		acf_add_local_field( array(
            ...
            'value' => self::$plugin_data == false? '' : self::$plugin_data['business_image']
		) );
	...
	public static function add_fields_rm_review_schema( $parent ) {
		...
		acf_add_local_field( array(
            ...
            'value' => self::$plugin_data == false? '' : self::$plugin_data['reviews_status']
		) );
		acf_add_local_field( array(
			'parent'	=> $parent,
            ...
            'value' => self::$plugin_data == false? '' : self::$plugin_data['reviews_url']
		) );
		...
		acf_add_local_field( array(
            ...
            'value' => self::$plugin_data == false? '' : self::$plugin_data['rating_value']
		) );
		...
		acf_add_local_field( array(
            ...
            'value' => self::$plugin_data == false? '' : self::$plugin_data['reviews_count']
		) );
		...
		acf_add_local_field( array(
            ...
            'value' => self::$plugin_data == false? '' : self::$plugin_data['reviews_schema_location']
		) );
	...
	public static function add_location_sub_fields() {
		...
		acf_add_local_field( array(
            ...
            'value' => self::$plugin_data == false? '' : self::$plugin_data['business_name']
		) );
		...
		acf_add_local_field( array(
			...
			'type'		=> 'text',
            'value' => self::$plugin_data == false? '' : self::$plugin_data['street_address']
		) );
		...
		acf_add_local_field( array(
			...
			'label'		=> 'City',
			'type'		=> 'text',
            'value' => self::$plugin_data == false? '' : self::$plugin_data['city']
		) );
		...
		acf_add_local_field( array(
			...
			'type'		=> 'text',
			'maxlength'	=> 3,
            'value' => self::$plugin_data == false? '' : self::$plugin_data['state']
		) );
		...
		acf_add_local_field( array(
			...
			'type'		=> 'text',
			'maxlength'	=> 12,
            'value' => self::$plugin_data == false? '' : self::$plugin_data['zipcode']
		) );
		...
		acf_add_local_field( array(
            ...
            'value' => self::$plugin_data == false? '' : self::$plugin_data['country']
		) );
		...
		acf_add_local_field( array(
            ...
            'value' => self::$plugin_data == false? '' : self::$plugin_data['phone']
		) );
		...
		acf_add_local_field( array(
            ...
            'value' => self::$plugin_data == false? '' : self::$plugin_data['latitude']
		) );
		...
		acf_add_local_field( array(
			...
			'max'			=> 180,
			'placeholder'	=> '000.0000',
            'value' => self::$plugin_data == false? '' : self::$plugin_data['longitude']
		) );
	...
	public static function add_employee_sub_fields() {
		...
		acf_add_local_field( array(
			...
			'layout'		=> 'horizontal',
			'other_choice'	=> true,
            'value' => self::$plugin_data == false? '' : self::$plugin_data['job_title']
		) );
		...
		acf_add_local_field( array(
            ...
            'value' => self::$plugin_data == false? '' : self::$plugin_data['image']
		) );
		...
		acf_add_local_field( array(
			...
			'label'		=> 'Link',
			'type'		=> 'link',
            'value' => self::$plugin_data == false? '' : self::$plugin_data['link']
		) );
